 ...
 */
final class Version20230630145125 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ReleveDecision (id INT AUTO_INCREMENT NOT NULL, DateReuSig DATETIME NOT NULL, NiveauRisque VARCHAR(255) DEFAULT NULL, InfoAvis LONGTEXT DEFAULT NULL, Classification_id INT DEFAULT NULL, PassageCTP_id INT DEFAULT NULL, PassageRSS_id INT DEFAULT NULL, Suivi_id INT DEFAULT NULL, INDEX IDX_FD82360A4256765 (Classification_id), INDEX IDX_FD82360A915D06B3 (PassageCTP_id), INDEX IDX_FD82360AF942A473 (PassageRSS_id), INDEX IDX_FD82360A869C3B96 (Suivi_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE SAVU (id INT AUTO_INCREMENT NOT NULL, CodeVU VARCHAR(255) DEFAULT NULL, CodeCIS VARCHAR(255) DEFAULT NULL, CodeDossier VARCHAR(255) DEFAULT NULL, NomVu VARCHAR(255) DEFAULT NULL, NumElement VARCHAR(255) DEFAULT NULL, CodeSubstance VARCHAR(255) DEFAULT NULL, NumComposant VARCHAR(255) DEFAULT NULL, CodeUniteDosage VARCHAR(255) DEFAULT NULL, CodeNature VARCHAR(255) DEFAULT NULL, DosageLibraTypo VARCHAR(255) DEFAULT NULL, DosageLibra VARCHAR(255) DEFAULT NULL, LibCourt VARCHAR(255) DEFAULT NULL, NomSubstance VARCHAR(255) DEFAULT NULL, CodeProduit VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE VUUtil (id INT AUTO_INCREMENT NOT NULL, CodeVU VARCHAR(255) NOT NULL, CodeCIS VARCHAR(255) DEFAULT NULL, CodeDossier VARCHAR(255) DEFAULT NULL, NomVU VARCHAR(255) DEFAULT NULL, dbo_Autorisation_libAbr VARCHAR(255) DEFAULT NULL, dbo_ClasseATC_libAbr VARCHAR(255) DEFAULT NULL, dbo_ClasseATC_libCourt VARCHAR(255) DEFAULT NULL, LibCourt VARCHAR(255) DEFAULT NULL, CodeContact VARCHAR(255) DEFAULT NULL, NomContactLibra VARCHAR(255) DEFAULT NULL, AdresseContact VARCHAR(255) DEFAULT NULL, AdresseCompl VARCHAR(255) DEFAULT NULL, CodePost VARCHAR(255) DEFAULT NULL, NomVille VARCHAR(255) DEFAULT NULL, TelContact VARCHAR(255) DEFAULT NULL, FaxContact VARCHAR(255) DEFAULT NULL, dbo_Pays_libCourt VARCHAR(255) DEFAULT NULL, dbo_StatutSpeci_libAbr VARCHAR(255) DEFAULT NULL, StatutAbrege VARCHAR(255) DEFAULT NULL, CodeActeur VARCHAR(255) DEFAULT NULL, CodeTigre VARCHAR(255) DEFAULT NULL, NomActeurLong VARCHAR(255) DEFAULT NULL, Adresse VARCHAR(255) DEFAULT NULL, AdresseComplExpl VARCHAR(255) DEFAULT NULL, CodePostExpl VARCHAR(255) DEFAULT NULL, NomVilleExpl VARCHAR(255) DEFAULT NULL, Complement VARCHAR(255) DEFAULT NULL, Tel VARCHAR(255) DEFAULT NULL, Fax VARCHAR(255) DEFAULT NULL, dbo_Pays_libAbr VARCHAR(255) DEFAULT NULL, CodeProduit VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
